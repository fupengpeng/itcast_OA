...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/ckeditor/samples/sample.css">
	...
	<div id="MainArea">
		...
		<center>
			<div class="ItemBlock_Title1" style="width: 98%">
				...
				<font class="MenuPoint"> &gt;&gt; </font> ${title} <span
					style="margin-left:30px;"> <s:a
						action="topic_addUI?forumId=%{forum.id}" namespace="/">
						<img align="absmiddle"
					...
					<tr valign="bottom">
						...
						<td class="ForumPageTableTitle" align="right"
							style="padding-right:12px;"><s:a cssClass="detail"
								action="reply_addUI?topicId=%{id}" namespace="/">
								<img border="0"
							...
							<tr>
								...
								<td class="Footer" height="28" align="center" valign="bottom">
									<ul style="margin: 0px; width: 98%;">
										...
										</font> <s:date name="postTime" format="yyyy-MM-dd HH:mm:ss" /></li>
										<li style="float: right;"><a
											href="javascript:scroll(0,0)"> <img border="0"

...
<script type="text/javascript">
    $(function(){
        /* 选择复选框name名为privilegeIds的所有复选框 */
        $('input[name=privilegeIds]').click(function(){
            //当选中某个权限时，同时选中其下级权限，取消某个权限时，同时取消其下级权限。
            //1.找到此权限的下级权限"ul",找到"ul"中的"input",设置这些input选中状态跟随此权限。
            $(this).siblings('ul').find('input').attr('checked',this.checked);
            //2.当选中某个权限时，同时选中其上级权限
            if(this.checked){
                $(this).parents('li').children('input').attr('checked',true);
            }else{
                //3.当取消某个权限时，如果同级权限都没有选中，则取消上级权限
						...
						<thead>
							<tr align="LEFT" valign="MIDDLE" id="TableTitle">
								<td width="300px" style="padding-left: 7px;">
									...
									<!-- 根据复选框的input的name属性值，确定是否选中，让它们跟随此input的选择状态而改变 -->
							...
							<tr class="TableDetail1">
								...
								<td>
									...
									<%-- <s:iterator value="privilegeList">
									    ...
									    value="${ id }" type="checkbox" name="privelegeIds"> ${name }
									    <br/>
								    </s:iterator> --%>
